...
(defun numericals/magicl:@ (matrix &rest matrices)
  (from-magicl-tensor
   (apply #'magicl:@
...
(defun numericals/magicl:block-diag (blocks)
  (from-magicl-tensor (magicl:block-diag (mapcar #'to-magicl-tensor blocks))))

(defun numericals/magicl:block-matrix (blocks shape)
...
(defun numericals/magicl:every (predicate tensor &rest more-tensors)
...
(defun numericals/magicl:hstack (matrices)
  (from-magicl-tensor
...
(defun numericals/magicl:notany (predicate tensor &rest more-tensors)
  (apply #'magicl:notany predicate (to-magicl-tensor tensor)
         (mapcar #'to-magicl-tensor more-tensors)))

(defun numericals/magicl:notevery (predicate tensor &rest more-tensors)
...
(defun numericals/magicl:some (predicate tensor &rest more-tensors)
...
(defun numericals/magicl:vstack (matrices)
  (from-magicl-tensor
