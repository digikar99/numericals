...
(defparameter double-list (loop for i below 6
                             collect (+ i 0.1d0)))
(defparameter arr (make-array '(6)
                              ...
                              (mapcar (lambda (i) (coerce i 'double-float))
                                      (alexandria:iota 6))
                              :element-type 'double-float))
(defparameter arr-a (make-array '(6) :initial-contents double-list
                                :element-type 'double-float))
(defparameter arr-b (make-array '(6) :initial-contents double-list
                                :element-type 'double-float))
(defparameter arr-c (make-array '(6) :initial-element 0.0d0
                                :element-type 'double-float))
