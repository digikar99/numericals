...
(define-numericals-one-arg-test nu:atan :dense-numericals (2f-7) (1d-15))

(define-numericals-two-arg-test nu:expt :dense-numericals t
    (2f-7  0.0f0 10.0f0 single-float)
    (1d-15 0.0d0 10.0d0 double-float))

(define-numericals-two-arg-test nu::atan2 :dense-numericals t
    (2f-7  0.0f0 10.0f0 single-float)
    (1d-15 0.0d0 10.0d0 double-float))
